 ...
 *
 */
package com.idyria.osi.aib3.core.dependencies

import org.scalatest.BeforeAndAfterAll
import org.scalatest.FeatureSpec
import scala.io.Source
import com.idyria.aib3.core.dependencies.maven.model.Project
...
class DependenciesTests extends FeatureSpec with BeforeAndAfterAll {
  ...
  feature("Project Model Parsing") {
    ...
    scenario("Maven Project") {
      ...
      //-- Load File
      var xmlinputBuffer = new StAXIOBuffer(new InputStreamReader(getClass().getResourceAsStream("model_maven_pom.xml")))
